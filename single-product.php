          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              ...
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    <span>Category</span> : <?php echo $result['catName']; ?></a
                  >
                </li>
                <li>
              ...
              <form action="" method="post">
                <div class="product_count">
                  ...
                  <input type="submit" class="main_btn" name="submit" value="Add to Cart"/>
              </form>
              <div class="card_area">
                    ...
                    <div class="add-cart">
                      <div class="mybutton">
                        <form action="" method="post">
                          <input type="hidden" class="main_btn" name="productId" value="<?php echo $result['productId']; ?>"/>              
                          <input type="submit" class="btn btn-sm btn-primary" name="compare" value="Add to Compare"/> | 
                          <input type="submit" class="btn btn-sm btn-info" name="wlist" value="Add to List"/>
                        </form>
                      </div>
                    </div>
                    <?php
